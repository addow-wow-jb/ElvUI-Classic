-- Korean localization file for koKR.(OptionsUI)-20210421
local L = ElvUI[1].Libs.ACL:NewLocale("ElvUI", "koKR")

L['|cffFF0000Warning:|r Changing options in this section will apply to all Buff Indicator auras. To change only one Aura, please click "Configure Auras" and change that specific Auras settings. If "Profile Specific" is selected it will apply to that filter set.'] = '|cffFF0000경고:|r 이 항목의 변경 옵션은 모든 버프 표시기 오라에 적용됩니다. 하나의 오라만 변경하려면 "오라 설정"을 클릭하고 특정 오라 설정을 변경하십시오. "프로필 설정"을 선택하면 해당 필터 세트에 적용됩니다.'
L["|cffFF0000Warning:|r Enable and Number of Groups are managed by Smart Raid Filter. Disable Smart Raid Filter in (UnitFrames - General) to change these settings."] = "|cffFF0000경고:|r 활성화 및 그룹 수는 Smart Raid 필터로 관리됩니다. 이러한 설정을 변경하려면 (UnitFrames-General)에서 Smart Raid Filter를 비활성화하십시오."
...
L["Additional Power Text"] = "추가 파워 글자"
...
L["AFK Mode"] = "자리비움 모드" -- Add translations -- 추가
L["Alerts"] = "알림"
L["Allow Sharing"] = "공유 허용" -- Add translations -- 추가
...
L["Ammo Pouch"] = "탄환 주머니" -- Add translations -- 추가
...
L["Are you sure you want to reset Cooldown settings?"] = "[Cooldown] 설정을 재설정 하시겠습니까?"
...
L["Are you sure you want to reset UnitFrames settings?"] = "[단위 프레임] 설정을 재설정 하시겠습니까?"
L["Ascending or Descending order."] = "오름차순 또는 내림차순."
L["Ascending"] = "오름차순"
L["Assist"] = "지원 공격" -- Add translations -- 추가
L["Assist Frames"] = "지원공격 전담 프레임"
L["Assist Target"] = "지원공격 대상" -- Incorrect Korean translation -- 번역 오류
...
L["Auctions"] = "경매장"
L["Auction Toggle"] = "경매장 가방열림" -- Add translations -- 추가
L["Aura"] = "오라(버프/디버프)"
L["Auras"] = "오라(버프/디버프)"
L["Aura Bars"] = "클래스타이머"
...
L["Battlefield"] = "전장대기 아이콘" -- Add translations -- 추가
L["Battlefield Frame"] = "전장 프레임" -- Add translations -- 추가
...
L["Class Icon"] = "클래식 아이콘" -- Add translations -- 추가
...
L["Coloring"] = "색상 설정 (공통)"
L["Colorize the tooltip border based on item quality."] = "표시 품질에 따라 툴팁 테두리에 색상을 나타냅니다." -- Add translations -- 추가
L["Colorize Selected Text"] = "선택한 창 색상 변경" -- Add translations -- 추가
...
L["Condensed"] = "간략하게"
L["Conditions"] = "주의 상황" -- Add translations -- 추가
...
L["Controls the width and how big of an area on the screen will accept clicks to target unit."] = "화면에서 타겟 단위에 대한 클릭을 허용할 너비와 영역의 크기를 제어합니다."
L["Cooldown Text"] = "재사용 대기시간 설정"
L["Cooldowns"] = "재사용 대기시간"
L["Copy Chat Lines"] = "대화 행별 복사 기능"
L["Copy From"] = "복사해오기"
L["Copy settings from %s. This will overwrite %s profile.\n\n Are you sure?"] = "%s에서 설정을 복사하여 %s 프로필을 덮어 씁니다. \n\n 계속 하시겠습니까?"
...
L["Desaturate Junk"] = "잡탬 흑백처리" -- "Desaturate Junk Items" 변경
...
L["Disable Sort"] = "정리 기능 끄기  " -- L["Disable Bag Sort"] = "가방 정리기능 끄기"
...
L["Display an exclamation mark on items that starts a quest."] = "퀘스트를 관여하는 항목에 느낌표를 표시합니다." -- Add translations -- 추가
...
L["Display data panels below the chat, used for datatexts."] = "채팅창 패널의 하단에 정보문자 탭을 추가합니다. 이 탭에 정보문자가 있게 됩니다."
...
L["Display Types"] = "기록할 종류" -- Add translations -- 추가
...
L["Display the New Item Glow"] = "가방에 새로 들어온 항목에 후광효과를 주어서 구분할수 있게 합니다."
...
L["Display the target of current cast."] = "현재 주문시전의 대상을 표시합니다." -- Add translations -- 추가
...
L["Display the unit name who interrupted a spell on the castbar. You should increase the 'Time to Hold' to show properly."] = "시전을 방해한 유닛(대상)을 시전바에 표시합니다. 제대로 표시하려면 [유지하는 시간]옵션을 늘려야합니다." -- There is a change in the sentence. -- 문장 변경 있어 수정.
...
L["Editbox History"] = "내가 쓴글 기록" -- Add translations -- 추가
...
L["Enable to hear sound if you receive a resurrect."] = "부활을 받으면 소리를들을 수 있습니다."
...
L["Equipped Item Color"] = "착용중 아이탬 색상" -- Add translations -- 추가
...
L["Fade Chat Toggles"] = "숨은 채팅창 버튼" -- Add translations -- 추가
L["Fade Duration"] = "투명도"
...
L["Fades the buttons that toggle chat windows when that window has been toggled off."] = "대화 창이 꺼졌을 때 대화 창을 전환시키는 버튼도 같이 숨김니다." -- Add translations -- 추가
...
L["Filter Modifiers"] = "필터 확인" -- Add translations -- 추가
...
L["Font Size"] = "글꼴 크기" -- Add translations -- 추가
L["Font"] = "글꼴"
L["Fonts"] = "글꼴"
...
L["Gems"] = "보석"
L["General"] = "일반"
L["General Options"] = "일반 옵션" -- Add translations -- 추가
...
L["Guardians"] = "경비병"
L["Guide:"] = "길잡이:"
L["Guild"] = "길드" -- Add translations -- 추가
...
L["HH:MM"] = "시:분" -- Add translations -- 추가
...
L["Hide Chat Toggles"] = "채팅창 숨김[<][>] 버튼" -- Add translations -- 추가
L["Hide Cooldown Bling"] = "재사용 깜빡임 끄기"
L["Hide Copy Button"] = "복사 버튼 숨기기" -- Add translations -- 추가
L["Hide Delay"] = "숨김 지연"
...
L["Icon: BOTTOMLEFT"] = "아이콘 - 왼쪽하단"
L["Icon: BOTTOMRIGHT"] = "아이콘 - 오른쪽하단"
L["Icon: LEFT"] = "아이콘 - 왼쪽"
L["Icon: RIGHT"] = "아이콘 - 오른쪽"
L["Icon: TOP"] = "아이콘 - 상단중앙"
L["Icon: TOPLEFT"] = "아이콘 - 왼쪽상단"
L["Icon: TOPRIGHT"] = "아이콘 - 오른쪽상단"
...
L["If enabled then the filter will activate if the unit is casting anything."] = "체크시 대상이 어떤 캐스팅을 시전하여도 필터가 적용됩니다." -- Add translations -- 추가
L["If enabled then the filter will activate if the unit is channeling anything."] = "체크시 대상이 어떤 체널링시전을 시전하여도 필터가 적용됩니다." -- Add translations -- 추가
L["If enabled then the filter will activate if the unit is not casting anything."] = "체크시 대상이 어떤 캐스팅도 하지 않으면 필터가 활성화됩니다." -- Add translations -- 추가
L["If enabled then the filter will activate if the unit is not channeling anything."] = "체크시 대상이 아무 체널링시전도 하지 않으면 필터가 활성화됩니다." -- Add translations -- 추가
...
L["If enabled then the filter will only activate when the unit is tap denied."] = "체크시 대상이 탭 거부 된 경우에만 필터가 작동합니다." -- I don't understand.'tap denied' -- 검토필요
...
L["Item Border Color"] = "아이템 등급 외곽선 표시"-- Add translations -- 추가
L["Item Level Threshold"] = "템렙표시 커트라인"
L["Item Level"] = "아이템 레벨"
L["Junk Icon"] = "잡탬 아이콘" -- Add translations -- 추가
L["JustifyH"] = "글자 가로 정렬방법"
L["Keep Size Ratio"] = "크기 비율 유지" -- Add translations -- 추가
L["Key Binding"] = "단축키 설정" -- Add translations -- 추가
...
L["Keyword Alerts"] = "단어 사용 알람" -- Add translations -- 추가
L["Keywords"] = "검색 단어"
L["Latency"] = "지연 시간 표시"
...
L["Macros"] = "매크로 설정"
L["Merchant"] = "상인" -- Add translations -- 추가
L["Macro Text"] = "매크로 이름 표시"
L["Mail"] = "우편" -- Add translations -- 추가
...
L["Max Lines"] = "최대 기록 라인 " -- Add translations -- 추가
L["Max Wraps"] = "최대 표시줄"
...
L["Missing"] = "알림"
L["MM:SS"] = "분:초" -- Add translations -- 추가
L["MM:SS Threshold"] = "분:초 표시 변경 값(초)"
L["Model Rotation"] = "3d 모델 회전"
L["Modifier for IDs"] = "ID 표시확인" -- Add translations -- 추가
...
L["Nameplate At Base"] = "이름표 바닥으로"
L["Negative Match"] = "부정 일치"
L["Neutral"] = "중립"
L["No Alert In Combat"] = "전투 중 알리지 않기"
L["No Duration"] = "시간제약 없는" -- Add translations -- 추가
L['No Label'] = '라벨 없음'
L["No Sorting"] = "구분 없음"
...
L["Off Tank Bad Transtion"] = "오프(보조) 탱커 나쁜 인계 "
L["Off Tank Good Transtion"] = "오프(보조) 탱커 좋은 인계"
L["Off Tank"] = "오프(보조) 탱커"
L["Officer"] = "관리자"
...
L["Overlay mode is forced when the Frame Orientation is set to Middle."] = "프레임 방향이 중앙으로 설정되면 오버레이 모드가 강제 실행됩니다." -- Add translations -- 추가
...
L["Quest Starter"] = "퀘스트 시작점" -- Option not working -- 작동안됨
L["Quests in Current Zone Only"] = "현재 지역의 퀘스트 만"
L["QuestTimers Frame"] = "퀘스트 타임 프레임" -- Add translations -- 추가
L["Quiver"] = "화살통" -- Add translations -- 추가
...
L["Replace Combat Font"] = "전투 글꼴 바꾸기" -- Add translations -- 추가
L["Replace Name Font"] = "이름 글꼴 바꾸기" -- Add translations -- 추가
...
L["Reset Editbox History"] = "내가 쓴글 기록 초기화" -- Add translations -- 추가
L["Reset filter priority to the default state."] = "필터 우선순위를 초기화합니다."
L["Reset Filter"] = "필터 초기화"
L["Reset History"] = "채팅기록 초기화" -- Add translations -- 추가
...
L["Reverse"] = "역방향"  -- Add translations -- 추가
...
L["Say"] = "일반 대화"
L["Scale"] = "크기"
L["Scrap Icon"] = "버리는 아이콘" -- Add translations -- 추가
...
L["Selector Color"] = "선택창 색상"  -- Add translations -- 추가
L["Selector Style"] = "선택창 스타일" -- Add translations -- 추가
...
L["Selected Text Color"] = "선택한 창 이름 색상" -- Add translations -- 추가
...
L["Shortcut to 'Filters' section of the config."] = "설정 메뉴의 [필터]항목으로 바로 가기." -- Add translations -- 추가
...
L["Show Count"] = "남은공간 표시" -- Add translations -- 추가
L["Show Dispellable Debuffs"] = "해제가능한 약화효과 표시"
L["Show ElvUI Users"] = "ElvUi 사용자 표시" -- Add translations -- 추가
L["Show ElvUI users and their version of ElvUI."] = "ElvUI 사용자 및 ElvUI의 버전표시." -- Add translations -- 추가
L["Show Empty Buttons"] = "빈칸 표시"
L["Show Icon"] = "아이콘 표시"
L["Show In Combat"] = "전투 중 표시"
L["Show Interrupt Source in Class Color"] = "직업색상으로 시전바 표시"
L["Show New Item Glow"] = "새로운 아이템 후광효과"
L["Show Only Names"] = "이름만을 표시" -- Nameplates.lua line 3732 , No local command -- 로컬 명령 없음
L["Show Quality Color"] = "품질 색상 표시"
L["Show Quest Icon"] = "퀘스트 아이콘 표시"  -- No sentences -- 문장 없음
...
L["Smart Raid Filter"] = "스마트 공격대 필터"
L["Smart"] = "스마트"
...
L["Sort Method"] = "정렬 기준"
L["Sorting"] = "정렬" -- Add translations -- 추가
L["Soul Bag"] = "영혼의 가방" -- Add translations -- 추가
L["Spaced"] = "외부에 작게 분리"
L["Spacing"] = "간격"
...
L["Stack Text Position"] = "중첩 문자 위치" -- No sentences -- 문장 없음
L["Stack Text X-Offset"] = "중첩 문자 X-좌표" -- No sentences -- 문장 없음
L["Stack Text Y-Offset"] = "중첩 문자 Y-좌표" -- No sentences -- 문장 없음
L["Stack Threshold"] = "중첩 기준점"
L["Start Near Center"] = "가운데 정렬"
L["Statusbar"] = "상태 표시 줄(버프 아이콘 하단에 바형태 시간타이머)" -- Add translations -- 추가
...
L["Style"] = "디자인"
L["Subzone Name"] = "하위 지역 이름" -- No sentences -- 문장 없음
L["Summon Icon"] = "소환 아이콘" -- No sentences -- 문장 없음
L["Support & Download"] = "지원 및 다운로드"
L["Support Forum"] = "지원 포럼"
L["Swipe: Normal"] = "사용불가 상황" -- Add translations -- 추가
L["Swipe: Loss of Control"] = "제어력 상실 상황" -- Add translations -- 추가
...
L["Tab Selector"] = "창이름 탭 선택" -- Add translations -- 추가
L["Tabard Frame"] = "휘장 프레임"
L["Table"] = "테이블"
L["Tagged NPC"] = "선점된 대상"
L["Talents"] = "특성 프레임" -- Add translations -- 추가
...
L["Taxi Frame"] = "택시(와이번/그리핀) 프레임" -- Add translations -- 추가
L["Template"] = "원형"
...
L["Top"] = "상단 중앙"
L["Totems"] = "토템"
L["Tracking"] = "추적기(광물/약초/야수추적 등)" -- Add translations -- 추가
L["Trade"] = "거래 요청"
L["Tradeskills"] = "전문 기술"
...
L["Tutorial Frame"] = "튜토리얼 프레임"
L["Type"] = "형태" -- Add translations -- 추가
...
L["Unit is Civilian"] = "대상이 민간인" -- Add translations -- 추가
L["Unit is Not Civilian"] = "대상이 민간인 아닌경우" -- Add translations -- 추가
...
L["Use the profile specific filter Buff Indicator (Profile) instead of the global filter Buff Indicator."] = "글로벌 필터 버프 표시기 대신 프로필 별 필터 버프 표시기 (프로필)를 사용합니다."
...
L["Value Color"] = "강조 색상"
L["VERTICAL"] = "수직방향"
L["Vehicle Exit"] = "교통수단 내리기 - 새이동시 중간 내리기버튼"
...
L["Whisper"] = "귓속말" -- Add translations -- 추가
L["Whitelist"] = "화이트리스트"
...
L["Word Wrap"] = "줄 바꿈"
L["World Map"] = "지도" -- Add translations -- 추가
...
----------------------------------
L["blockCastByPlayers"] = "유저들 주문을 [숨김]"
L["blockDispellable"] = "해제가능 주문을 [숨김]"
L["blockNoDuration"] = "시간제약 없는오라 [숨김}"
L["blockNonPersonal"] = "내주문을제외하고 [숨김]"
L["blockNotDispellable"] = "차단 불가 [숨김]"
L["Boss"] = "[보기] 보스 주문만"
L["CastByNPC"] = "[보기] NPC 주문만"
L["CastByPlayers"] = "[보기] 유저들의 주문만"
L["CastByUnit"] = "[보기] 대상의 주문만"
L["Dispellable"] = "[보기] 해제/차단 가능만"
L["nonPersonal"] = "[보기] 내주문을제외한"
L["notCastByUnit"] = "[보기] 대상의주문을제외한 "
L["notDispellable"] = "[보기] 차단/해재 불가"
L["MyPet"] = "[보기] 내 팻의 주문만"
L["OtherPet"] = "[보기] 다른 팻의 주문만"
----------------------------------
...
L["ANCHOR_CURSOR"] = "커서 위치"
L["ANCHOR_CURSOR_LEFT"] = "커서 왼쪽"
L["ANCHOR_CURSOR_RIGHT"] = "커서 오른쪽"
----------------------------------
